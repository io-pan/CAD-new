/*  
  ...
  . load cadastre / ign map 
    . make it fit and display in overlay
    . synchronize controls with map
  . snpashot whole region at max zoom level. 0.002 as lat/lon dela should be fine.
  . 3D view of points
*/
...
{/*        <View style = { this.maskStyle() } >
          <Text style={styles.w_text}> Waiting for FOV ...</Text>
        </View>
*/}
      </View>
    )
